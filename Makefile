...
SRCC += $(DDIR)uart.c $(DDIR)pwm.c $(DDIR)gps.c $(DDIR)i2c.c $(DDIR)itg3200.c $(DDIR)bma180.c

# RTOS source files
SRCC +=	$(RTOS_DIR)list.c $(RTOS_DIR)tasks.c $(RTOS_DIR)queue.c $(RTOS_PORT)port.c $(RTOS_MEM)heap_1.c

# User program source files
SRCC +=	$(DIR)main.c $(DIR)misc.c $(DIR)fmath.c $(DIR)kalman.c $(DIR)pid.c $(DIR)sensors.c $(DIR)input.c 
...
SRCO += misc.o fmath.o leds.o timer.o uart.o pwm.o gps.o kalman.o pid.o i2c.o itg3200.o bma180.o sensors.o
SRCO += input.o
